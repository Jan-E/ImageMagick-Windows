...
clone_repository $1 $2 'ImageMagick' 'ImageMagick-6' 'ImageMagick' '9c8e6a5'
...
clone_repository $1 $2 'png' 'master' 'png' '8d6fce5'
clone_repository $1 $2 'tiff'
clone_repository $1 $2 'ttf'
clone_repository $1 $2 'VisualMagick' 'VisualMagick-6' 'VisualMagick' '07cab36'
